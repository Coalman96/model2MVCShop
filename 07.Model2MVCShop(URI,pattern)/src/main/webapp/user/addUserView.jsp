	...
	<script type="text/javascript">
		...
		//============= "가입"  Event 연결 =============
		 $(function() {
			...
			$( "button.btn.btn-primary" ).eq(0).on("click" , function() {
				fncAddUser();
			});
			
			$( "button.btn.btn-primary" ).eq(1).on("click" , function() {
				history.go(-1);
			});
			 ...
			 $("#userId").on("input", function() {
			        ...
			        // AJAX 요청을 보내서 아이디 중복 확인
			        $.ajax({
			            url: "/user/json/checkDuplication/"+userId, // 서버 측 엔드포인트 URL로 변경해야 함
			            method: "POST",
			            data: { userId: userId },
			            ...
			            error: function() {
			            	 $("strong.text-danger").eq(0).html("아이디 확인 중 오류가 발생했습니다.");
			            }
			        });
			    });
...
<body>
	...
	<div class="container">
		...
		<h1 class="text-center" style="margin-bottom:50px">회 원 가 입</h1>
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId">
		       <span >
		      	<strong class="text-danger">아이디는 3글자 이상 입력해야합니다.</strong>
		      </span>
		    </div>
		    <!-- <div class="col-sm-3">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" class="btn btn-primary" style="width:100px" >가 &nbsp;입</button>
			  <button type="button" class="btn btn-primary" style="width:100px">취&nbsp;소</button>
		    </div>
		  </div>
		</form>
		<!-- form Start /////////////////////////////////////-->
